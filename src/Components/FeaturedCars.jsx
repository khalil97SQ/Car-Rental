...
import { ArrowRight, Car, Cog, Fuel, MapPin, Star, User } from "lucide-react";
    ...
    <section className="bg-gray-100 py-20 sm:px-16 px-4 ">
      <div className="max-w-7xl mx-auto text-center mb-12 head-reveal">
        ...
        <p className="text-gray-600 text-lg">
          Dicover our handpicked selection of premium vehicles, perfect for any
          journey.
        </p>
      </div>
          ...
          return (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <span className="absolute top-2 right-2 bg-green-500 text-xs font-semibold px-2 py-1 rounded-full shadow text-white">
                  {car.status}
                </span>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="flex sm:items-center sm:flex-row flex-col sm:gap-10 gap-2 mt-2 text-gray-600 text-sm">
                  <span className="inline-flex items-center gap-1">
                    <User className="w-4 h-4 text-blue-500" /> {car.seats} seats
                  </span>
                  <span className="inline-flex items-center gap-1">
                    <Cog className="w-4 h-4 text-blue-500" /> {car.transmission}
                  </span>
                  <span className="inline-flex items-center gap-1">
                    <Fuel className="w-4 h-4 text-blue-500" /> {car.fuel} seats
                  </span>
                </div>
                ...
                <div className="flex sm:flex-row flex-col mt-4 gap-3">
                  ...
                  <button className="sm:w-1/2 w-full border border-gray-300 px-3 py-2 rounded bg-green-500 text-white cursor-pointer transition duration-300 hover:bg-green-700">
                    Book Now
                  </button>
                </div>
              </div>
      ...
      <button className="mx-auto flex items-center justify-center mt-12 bg-blue-500 py-3 px-5 text-white rounded cursor-pointer gap-2 transition duration-300 hover:bg-blue-700">
        <span className="mb-1">View All Cars</span>{" "}
